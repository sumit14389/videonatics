...
public class VideoByGroupListActivity extends DisplayScreen implements OnNavigationListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		util = new Util(this);
		customProgress = new CustomProgress(VideoByGroupListActivity.this, R.string.loading_msg);
		initView();
			...
			public void handleMessage(Message msg)
			{
				VReturn vReturn = (VReturn)msg.obj;
				  if(vReturn.getReturnValue() == VReturn.SUCCESS){
				   ...
				   ListAdapter adapter = new ListAdapter(VideoByGroupListActivity.this,R.layout.custom_thumb_list, Constant.vChannelsListView,videoThumbList);
				   videoThumbList.setAdapter(adapter);
...
//						String fromActivity = "mapVisibilityGone";
						customProgress.show();
						VChannel vChannel  = (VChannel) Constant.vChannelsListView.get(position);
						Intent intent = new Intent(VideoByGroupListActivity.this,MjpegLiveViewFromGroupOrLocation.class);
	   ...
	   protected void callLogout(final long loginSession) {
			...
			locationHandler = new Handler() {
				public void handleMessage(Message msg) {
					...
					// progress.dismiss();
					Intent intent = new Intent(VideoByGroupListActivity.this,
							LoginActivity.class);
					startActivity(intent);
		...
		private void callSiteMapActivity() {
			// TODO Auto-generated method stub
			Intent intent = new Intent(VideoByGroupListActivity.this,SiteMapActivity.class);
			startActivity(intent);
			overridePendingTransition(R.anim.zoom_enter, R.anim.zoom_exit);
		}
		...
		private void callVideoByLocation() {
			// TODO Auto-generated method stub
			Intent intent = new Intent(VideoByGroupListActivity.this,VideoByLocationActivity.class);
			startActivity(intent);
			overridePendingTransition(R.anim.zoom_enter, R.anim.zoom_exit);
		}

		private void callDasboardActivity() {
			Intent intent = new Intent(VideoByGroupListActivity.this, DashboardActivity.class);
			startActivity(intent);
			overridePendingTransition(R.anim.zoom_enter, R.anim.zoom_exit);
